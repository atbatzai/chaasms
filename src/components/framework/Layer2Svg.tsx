          ...
          <div className="overflow-x-auto">
            <table className="w-full">
              ...
              <tbody>
                ...
                {/* Advanced Row */}
                <tr>
                  <td className="p-3 font-bold" style={{ color: colors.text.light, backgroundColor: colors.tiers.gold }}>
                    Advanced
                  </td>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
          ...
          >
            ...
            <div className="space-y-4">
              <div className="p-3 rounded" style={{ backgroundColor: 'rgba(52, 152, 219, 0.2)' }}>
                ...
                <div style={{ color: colors.text.dark }}>Specialized expertise by integration type</div>
              </div>
              
              <div className="p-3 rounded" style={{ backgroundColor: 'rgba(52, 152, 219, 0.2)' }}>
                <div className="font-bold mb-1" style={{ color: colors.primary }}>Specialization Model</div>
                <div style={{ color: colors.text.dark }}>Ecosystem & marketplace focused advancement</div>
              </div>
              
              <div className="p-3 rounded" style={{ backgroundColor: 'rgba(52, 152, 219, 0.2)' }}>
                <div className="font-bold mb-1" style={{ color: colors.primary }}>Enablement Framework</div>
                <div style={{ color: colors.text.dark }}>Training & certification by expertise</div>
              </div>
              
              <div className="p-3 rounded" style={{ backgroundColor: 'rgba(52, 152, 219, 0.2)' }}>
                <div className="font-bold mb-1" style={{ color: colors.primary }}>Incentive Model</div>
                <div style={{ color: colors.text.dark }}>Marketplace-aligned rewards & recognition</div>
              </div>
            </div>
          </div>
          ...
          >
            ...
            <div className="mb-6">
              ...
              <div className="border-b mb-2" style={{ borderColor: colors.secondary }}></div>
              
              <div className="flex justify-between mb-2">
                <div style={{ color: colors.text.dark }}>New Partners (Quarterly)</div>
                <div className="font-bold" style={{ color: colors.primary }}>20+</div>
              </div>
              
              <div className="flex justify-between mb-2">
                <div style={{ color: colors.text.dark }}>Partner Mix Ratio</div>
                <div className="font-bold" style={{ color: colors.primary }}>Balanced</div>
              </div>
              
              <div className="flex justify-between mb-2">
                <div style={{ color: colors.text.dark }}>Ecosystem Coverage</div>
                <div className="font-bold" style={{ color: colors.primary }}>85%+</div>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="flex justify-between mb-2">
                <div style={{ color: colors.text.dark }}>Time to First Deal</div>
                <div className="font-bold" style={{ color: colors.primary }}>&lt;90 days</div>
              </div>
              
              <div className="flex justify-between mb-2">
                <div style={{ color: colors.text.dark }}>Partner Satisfaction</div>
                <div className="font-bold" style={{ color: colors.primary }}>4.5/5.0</div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="mb-6">
          ...
          <div className="flex flex-wrap justify-between gap-4">
            ...
            >
              ...
              <div className="text-sm" style={{ color: colors.text.dark }}>Centralized resource hub</div>
            </div>
            ...
            >
              ...
              <div className="text-sm" style={{ color: colors.text.dark }}>Capability-based learning</div>
            </div>
            ...
            >
              ...
              <div className="text-sm" style={{ color: colors.text.dark }}>Opportunity protection</div>
            </div>
            ...
            >
              ...
              <div className="text-sm" style={{ color: colors.text.dark }}>Co-brandable assets</div>
            </div>
            ...
            >
              ...
              <div className="text-sm" style={{ color: colors.text.dark }}>Integration showcases</div>
            </div>
          </div>
        </div>
